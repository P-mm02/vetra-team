...
export const projectUiText = {
  th: {
    ...
    searchPlaceholder: 'ค้นหา: ชื่อ / รายละเอียด / ปี / stack ...',
    clearSearch: 'Clear search',
    detail: 'รายละเอียด',
    empty: 'ไม่พบผลงานที่ตรงกับคำค้นหา',
  },
  en: {
    example: 'Featured',
    all: 'All',
    searchLabel: 'Search by title, description, year, stack, highlights',
    searchPlaceholder: 'Search by name, description, year, stack...',
    clearSearch: 'Clear search',
    detail: 'Details',
