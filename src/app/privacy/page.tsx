...
export const metadata: Metadata = {
  title: 'Privacy',
  description:
    'นโยบายความเป็นส่วนตัวของ Wee | Freelance — การเก็บข้อมูล การใช้งานคุกกี้ และสิทธิของผู้ใช้งาน',
  alternates: { canonical: '/privacy' },
  openGraph: {
    title: 'Privacy | Wee | Freelance',
    description:
...
const sections: Section[] = [
  {
    ...
    title: 'ภาพรวม',
    body: [
      'นโยบายนี้อธิบายว่า Wee | Freelance (“เรา”) เก็บ ใช้ และปกป้องข้อมูลของคุณอย่างไรเมื่อคุณเข้าชมเว็บไซต์หรือส่งข้อมูลติดต่อ.',
